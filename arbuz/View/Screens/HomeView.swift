    ...
    var body: some View {
        ScrollView() {
            VStack {
                ...
                ProductCell(product: homeVM.topProduct, onCardTap: {
                    delegate.didTapOnProduct(id: homeVM.topProduct.idIngredient!)
                })
                    ...
                    LazyHStack(spacing: 24) {
                        ForEach(homeVM.productsOfDay.meals, id: \.self) {
                            ...
                            ProductCell(product: product,
                                        onCardTap: {
                                delegate.didTapOnProduct(id: product.idIngredient!)
                            })
