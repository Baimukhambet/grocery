...
//    func buildView(rowIndex: Int, geometry: GeometryProxy){
//        var rowCards = [Card]()
...
//            return RowView(cards: rowCa/*rds, width: getWidth(geometry: geometry), height: width * 1.2, horizontalSpacing: horizontalSpacing)*/
//        }
//        
//        return nil
//    }
